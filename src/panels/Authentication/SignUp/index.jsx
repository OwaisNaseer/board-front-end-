...
export const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const registrationPayload = {
      ...
      role: formData?.accountType?.value?.toLowerCase(),
      ...
      <div className='mx-auto w-full max-w-sm lg:w-96'>
        ...
        <div className='mt-8'>
          ...
          <form onSubmit={handleSubmit} className=''>
            ...
            {/* <div className="w-full my-6 pt-2 h-[80px] bg-secondary-light rounded text-center text-sm text-secondary-dark flex items-center justify-center">
              Captcha
            </div> */}
            ...
            <div className='space-y-5 mt-5'>
              ...
              <div className='flex flex-col gap-2'>
                <CustomButton
                  disabled={
                    isEmpty(formData) || !isPasswordValid || !agreeTerms
                  }
                  type='submit'
                  loading={loading}
                  sx={{
